...
# def showimg_T2(resultDir,start, end, obsdata, simdata):
resultDir="C:\\Bokai\\xampp\\htdocs\\php\\TW_SIM_Evaluate\\public\\MetData\\Evaluate\\2020-03-07-14-36-58_2016-12-01-2016-12-31\\Result"
start="2016-12-01"
end="2016-12-31"
obsdata="2016-12-01_2016-12-31_T2_obs.xlsx"
simdata="2016-12-01_2016-12-31_T2_sim.xlsx"


imgdir = resultDir+"\\imgs"
t2dir  = resultDir+"\\imgs\\T2"
if not os.path.isdir(imgdir):
    os.mkdir(imgdir)
if not os.path.isdir(t2dir):
    os.mkdir(t2dir)
...
for ston in stons:
    ...
    # plt.plot(range(0,24,1), stons_obs_avg[ston][0:24],
    #     color='black', lw=3, label= 'obs')
    # plt.plot(range(0,24,1), stons_sim_avg[ston][0:24],
    ...
    # plt.savefig(t2dir+'\\'+ start.strftime('%Y-%m-%d')+"_"+end.strftime('%Y-%m-%d')+"average"+ston+".png", dpi=500, format="png")
