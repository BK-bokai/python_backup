...
filePath = 'D:\\bokai\\python\\python-code\\calmet\\20191216案例\\模擬結果\\avg.BAS'


files = os.listdir("D:\\bokai\\python\\python-code\\calmet\\20191216案例\\模擬結果\\uv") 
for x in files:
    time=x.replace("uv.txt","")
    outfilepath='D:\\bokai\\python\\python-code\\calmet\\20191216案例\\模擬結果\\avgscript\\'+time+'.BAS'
    ...
    executPath = '"D:\\bokai\\python\\python-code\\calmet\\20191216案例\\模擬結果\\avgscript\\'+time+'.BAS'+'"'
