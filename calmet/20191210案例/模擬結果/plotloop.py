...
filePath = 'D:\\bokai\\python\\python-code\\calmet\\20191210案例\\模擬結果\\plot.BAS'
...
for x in files:
    ...
    outfilepath='D:\\bokai\\python\\python-code\\calmet\\20191210案例\\模擬結果\\plotscript\\'+time+'_plot'+'.BAS'
    ...
    executPath = '"D:\/bokai\python\python-code\calmet\/20191210案例\模擬結果\/plotscript\/'+time+'_plot'+'.BAS'+'"'
