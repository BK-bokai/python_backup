...
col_names = ['temperature', 'dewpoint', 'direction', 'speed']

df = pd.read_fwf(get_test_data('46000-2018073100.txt', as_file_obj=False),
                 skiprows=3, usecols=[0, 1, 2, 3], names=col_names)
...
# # Show the plot
# # plt.show()
# plt.savefig("skew.png",dpi=300,format="png")
