...
for i in range(0,144,24):
    ...
    plt.plot(x2[i:i+24],Tainan_obs[i:i+24],color='black',lw=3,label='Tainan_obs')
    plt.plot(x2[i:i+24],Tainan_simu[i:i+24],color='green',lw=3,label='Tainan_simu')
    ...
    plt.savefig("2019-"+(x2[i][0:5])+"Tainan.png",dpi=500,format="png")