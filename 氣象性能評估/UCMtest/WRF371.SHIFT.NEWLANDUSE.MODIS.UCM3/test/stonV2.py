...
date = "201611"
mon = date[4:6]
obs = pd.read_excel("201611obs.xlsx")
sim = pd.read_excel("201611sim.xlsx")
...
#     plt.savefig("D:\\bokai\\python\\python-code\\氣象性能評估\\UCMtest\\WRF371.SHIFT.NEWLANDUSE.MODIS.UCM3\\"+mon+"月\\"+mon+"月img\\2016-" +
#             x2[0][0:2]+ston+".png", dpi=500, format="png")


# with open(date+"obs_avg.csv", 'w', newline='') as csvFile:
...
# with open(date+"sim_avg.csv", 'w', newline='') as csvFile:
#     writer = csv.writer(csvFile)
#     writer.writerow(['UTC','台北', '板橋', '新竹', '宜蘭', '花蓮', '梧棲', '台中', '嘉義', '永康', '台南', '台東', '高雄', '恆春'])
#     for i in range(0,24):
