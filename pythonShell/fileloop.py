...
files = os.listdir("D:\\bokai\\劉博凱_景丰\\calmet\\20190619南科案例\\模擬結果\\uv") 
for x in files:
    time=x.replace("uv.txt","")
    outfilepath='D:\\bokai\\劉博凱_景丰\\calmet\\20190619南科案例\\模擬結果\\avgscript\\'+time+'.BAS'
    ...
    executPath = '"D:\/bokai\劉博凱_景丰\calmet\/20190619南科案例\模擬結果\/avgscript\/'+time+'.BAS'+'"'
